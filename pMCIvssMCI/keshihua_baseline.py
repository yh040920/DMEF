...
def main():
    ...
    # 模型路径
    model_path = r"/3251903008/yyh/result_MoE_SMCI&PMCI/ACNN_ablation_20260628_112038_data_dataArgument/models/3DNet4l_1_ACNN_epoch_20_d1_det.pt"
    
    # dropout参数
    dropout = 0.0

    # 保存可视化结果的目录
    save_dir = r"/3251903008/yyh/result_MoE_SMCI&PMCI/ACNN_ablation_20260628_112038_data_dataArgument"
