...
def get_args():
    ...
    parser.add_argument('--train_root_path', type=str, help='Root path for train dataset',
                        default=r'/3251903008/yyh/pMCIsMCI/split_dataset_4/train')
    parser.add_argument('--val_root_path', type=str, help='Root path for val dataset',
                        default=r'/3251903008/yyh/pMCIsMCI/split_dataset_4/val')
    parser.add_argument('--test_root_path', type=str, help='Root path for test dataset',
                        default=r'/3251903008/yyh/pMCIsMCI/split_dataset_4/test')
    parser.add_argument('--excel_file', type=str, help='excel file for scores',
                        default=r'/3251903008/yyh/pMCIsMCI/adni_1203s_info_fixshort.xlsx')
    ...
    parser.add_argument('--model_path', type=str, help='Path to the pretrained model file (.pt)', default="/3251903008/yyh/result_MoE_plus/MoE_20260307_135850_image1_dataArgument_top2_bl0.05_dl0.01_detach/models/3DNet4l_1_tp4_sifeature_clonefs_1bt1_l43_1_epoch_59_d1_det.pt")
