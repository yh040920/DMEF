...
def main():
    ...
    # 模型路径
    model_path = r"/3251903008/yyh/result_MoE_plus/a_20260311_133241_image1_dataArgument_concat_noMoE/models/3DNet4l_1_tp4_sifeature_clonefs_1bt1_l43_1_epoch_49_d1_det.pt"
    
    # dropout参数
    dropout = 0.0

    # 保存可视化结果的目录
    save_dir = r"/3251903008/yyh/result_MoE_plus/a_20260311_133241_image1_dataArgument_concat_noMoE"
